...
The frontend is deployed on Vercel. Add the same `VITE_SUPABASE_URL` and `VITE_SUPABASE_ANON_KEY` values to the Vercel project environment variables, then deploy the application with:
